    ...
    <div>
        <div class="page-titles p-3 border-bottom">
            <h3 class="text-themecolor">{{trans('todo.edit_todo')}}
                <button class="btn btn-info btn-sm pull-right" @click="$router.push('/branch')"><i class="fas fa-check-circle"></i> <span class="d-none d-sm-inline">{{trans('todo.todo')}}</span></button>
            </h3>
        </div>
