      ...
      <div class="col-12 col-sm-4">
        <div class="form-group">
          ...
          <input
            ...
            type="text"
            value
            v-model="ipFilterForm.start_ip"
            name="start_ip"
            :placeholder="trans('ip_filter.start_ip')"
          />
      ...
      <div class="col-12 col-sm-4">
        <div class="form-group">
          ...
          <input
            ...
            type="text"
            value
            v-model="ipFilterForm.end_ip"
            name="end_ip"
            :placeholder="trans('ip_filter.end_ip')"
          />
...
export default {
  ...
  methods: {
    proceed() {
      if (this.id) this.updateIpFilter();
      else this.storeIpFilter();
    },
    storeIpFilter() {
      this.ipFilterForm
        .post("/api/ip-filter")
