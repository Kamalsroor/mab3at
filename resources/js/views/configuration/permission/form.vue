<template>
  <form
    ...
    @keydown="permissionForm.errors.clear($event.target.name)"
  >
    ...
    <div class="form-group">
      <label for>{{trans('permission.label')}}</label>
      <input
        class="form-control"
        type="text"
        value
        ...
        name="label"
        :placeholder="trans('permission.label')"
      />
      <show-error :form-label="permissionForm" prop-name="label"></show-error>
    </div>
