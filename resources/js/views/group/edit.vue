    ...
    <div>
        <div class="page-titles p-3 border-bottom">
            <h3 class="text-themecolor">{{trans('todo.edit_todo')}}
                <button class="btn btn-info btn-sm pull-left" @click="$router.push('/group')"><i class="fas fa-check-circle"></i> <span class="d-none d-sm-inline">{{trans('group.all_group')}}</span></button>
            </h3>
        </div>
...
<script>
    ...
    export default {
        ...
        mounted(){
            if(!helper.hasPermission('edit-group')){
