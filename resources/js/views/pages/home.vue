    ...
    <div class="page-titles p-3 border-bottom">
      <h3 class="text-themecolor">
        ...
        >
          ...
          <span class="d-none d-sm-inline">{{trans('auth.logout')}}</span>
        </button>
      </h3>
    </div>
        ...
        <div class="col-12 col-sm-3">
          <div class="card">
            <div class="card-body px-3 pt-3">
              <h4
                class="card-title"
              >{{trans('dashboard.period_registered_user',{period: trans('dashboard.total')})}}</h4>
              <div class="text-right">
                <h2 class="font-light m-b-0">
                  <i class="fas fa-users fa-lg pull-right m-r-40"></i>
        ...
        <div class="col-12 col-sm-3">
          <div class="card">
            <div class="card-body px-3 pt-3">
              <h4
                class="card-title"
              >{{trans('dashboard.period_registered_user',{period: trans('dashboard.today')})}}</h4>
              <div class="text-right">
                <h2 class="font-light m-b-0">
                  <i class="fas fa-users fa-lg pull-right m-r-40"></i>
                  <span class="pull-left">{{today_registered_users}}</span>
                </h2>
              </div>
            </div>
          </div>
        ...
        <div class="col-12 col-sm-3">
          <div class="card">
            <div class="card-body px-3 pt-3">
              <h4
                class="card-title"
              >{{trans('dashboard.period_registered_user',{period: trans('dashboard.week')})}}</h4>
              <div class="text-right">
                <h2 class="font-light m-b-0">
                  <i class="fas fa-users fa-lg pull-right m-r-40"></i>
                  <span class="pull-left">{{weekly_registered_users}}</span>
                </h2>
              </div>
            </div>
          </div>
        ...
        <div class="col-12 col-sm-3">
          <div class="card">
            <div class="card-body px-3 pt-3">
              <h4
                class="card-title"
              >{{trans('dashboard.period_registered_user',{period: trans('dashboard.month')})}}</h4>
              <div class="text-right">
                <h2 class="font-light m-b-0">
                  <i class="fas fa-users fa-lg pull-right m-r-40"></i>
                  <span class="pull-left">{{monthly_registered_users}}</span>
                </h2>
              </div>
            </div>
          </div>
    ...
    updatePreference() {
      this.preferenceForm
        ...
        .then(response => {
          ...
          $("#theme").attr(
            "href",
            "/css/colors/" + this.preferenceForm.color_theme + ".css"
          );

          if (
            this.user_preference.direction != this.preferenceForm.direction ||
            this.user_preference.sidebar != this.preferenceForm.sidebar ||
            this.user_preference.locale != this.preferenceForm.locale
          )
            location.reload();
        })
        .catch(error => {
      ...
      preferenceForm: new Form(
        {
          ...
          direction:
            helper.getConfig("user_direction") || helper.getConfig("direction"),
          locale: helper.getConfig("user_locale") || helper.getConfig("locale"),
          sidebar:
            helper.getConfig("user_sidebar") || helper.getConfig("sidebar")
        },
        false
      ),
      user_preference: {
