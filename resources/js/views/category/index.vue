  ...
  <div>
    <div class="page-titles p-3 border-bottom">
      <h3 class="text-themecolor">
        ...
        <span class="card-subtitle" v-if="categories">{{
          trans("general.total_result_found", { count: categories.total })
        }}</span>
        ...
        <sort-by
          ...
          @updateSortBy="
            (value) => {
              filterTodoForm.sort_by = value;
            }
          "
          @updateOrder="
            (value) => {
              filterTodoForm.order = value;
            }
          "
        ></sort-by>
        <button
        ...
        <button
          class="btn btn-info btn-sm pull-right m-r-10"
          v-if="categories.total && !showCreatePanel"
                  ...
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <input
                        class="form-control"
                        name="keyword"
                        v-model="filterTodoForm.keyword"
                      />
                    </div>
                  </div>
                  <div class="col-6">
              ...
              >
                <div slot="btn">
                  <button
                    ...
                    @click="showCreatePanel = !showCreatePanel"
                  >
                    <i class="fas fa-plus"></i> {{ trans("general.add_new") }}
                  </button>
                </div>
              </module-info>
              <pagination-record
