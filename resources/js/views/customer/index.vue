    ...
    <div class="page-titles p-3 border-bottom">
      <h3 class="text-themecolor">
        ...
        <span
          class="card-subtitle"
          v-if="customers"
        >{{trans('general.total_result_found',{'count' : customers.total})}}</span>
        ...
        <button
          class="btn btn-info btn-sm pull-right m-r-10"
          v-if="customers.total && !showCreatePanel"
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr v-for="(customer, index) in customers.data" :key="index">
                      ...
                      <td
                        v-text="customer.user.profile.first_name+' '+customer.user.profile.last_name"
                      ></td>
                      <td class="table-option">
                        <div class="btn-group">
                          ...
                          <button
                            ...
                            :key="customer.id"
                            v-confirm="{ok: confirmDelete(customer)}"
