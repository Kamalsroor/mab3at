  ...
  check() {
    return axios
      ...
      .then(response => {
        ...
        if (response.ip_restricted) localStorage.setItem("ip_restricted", true);
        else localStorage.removeItem("ip_restricted");
        ...
        if (response.authenticated) {
          store.dispatch("setAuthUserDetail", {
            ...
            color_theme:
              response.user.user_preference.color_theme ||
              this.getConfig("color_theme"),
            locale:
              response.user.user_preference.locale || this.getConfig("locale"),
            direction:
              response.user.user_preference.direction ||
              this.getConfig("direction"),
            sidebar:
              response.user.user_preference.sidebar || this.getConfig("sidebar")
          });
