  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <router-link to="/" class="brand-link">
      <img
        ...
        style="opacity: .8"
      />
      <span class="brand-text font-weight-light">{{getConfig("company_name")}}</span>
    </router-link>
    ...
    <div class="sidebar">
      <div>
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img :src="getAuthUser('avatar')" class="img-circle elevation-2" alt="User Image" />
          </div>
          <div class="info">
            <a href="#" class="d-block">{{getAuthUser('full_name')}}</a>
          </div>
        </div>
