...
use App\DebentureCashing;
use Illuminate\Http\Request;
use App\Http\Requests\DebentureCashingRequest;
use App\Repositories\UserRepository;
use App\Repositories\DebentureCashingRepository;
...
class DebentureCashingController extends Controller
{
    protected $module = 'debenture_cashing';
     ...
     * @return void
     */
    public function __construct(Request $request, DebentureCashingRepository $repo, UserRepository $user, BranchRepository $branch, CustomerRepository $customer, ActivityLogRepository $activity)
    {
     ...
     * @return Response
     */
    public function store(DebentureCashingRequest $request)
    {
     ...
     * @return Response
     */
    public function update($id, DebentureCashingRequest $request)
    {
