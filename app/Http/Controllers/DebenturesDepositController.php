...
use App\Http\Requests\DebenturesDepositRequest;
use App\Repositories\UserRepository;
use App\Repositories\DebenturesDepositRepository;
...
class DebenturesDepositController extends Controller
{
    protected $module = 'debenture_deposit';
     ...
     * @return void
     */
    public function __construct(Request $request, DebenturesDepositRepository $repo, UserRepository $user, BranchRepository $branch, CustomerRepository $customer, ActivityLogRepository $activity)
    {
     ...
     * @return Response
     */
    public function store(DebenturesDepositRequest $request)
    {
     ...
     * @return Response
     */
    public function update($id, DebenturesDepositRequest $request)
    {
