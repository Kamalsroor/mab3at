...
class SalesBillController extends Controller
{
     ...
     * @return void
     */
    public function __construct(Request $request, productRepository $product, SalesBillRepository $repo, UserRepository $user, BranchRepository $branch, CustomerRepository $customer, ActivityLogRepository $activity)
    {
     ...
     * @return Response
     */
    public function store(SalesBillRequest $request)
    {
     ...
     * @return Response
     */
    public function update($id, SalesBillRequest $request)
    {
