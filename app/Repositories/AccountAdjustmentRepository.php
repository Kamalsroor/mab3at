...
class AccountAdjustmentRepository
{
     ...
     * @return void
     */
    public function __construct(AccountAdjustment $account_adjustment)
    {
        $this->data = $account_adjustment->with('user', 'user.profile', 'customer');
    }
     ...
     * @return branch
     */
    public function update(AccountAdjustment $account_adjustment, $params)
    {
        $account_adjustment->forceFill($this->formatParams($params, 'update'))->save();
        return $account_adjustment;
    }
     ...
     * @return bool|null
     */
    public function delete(AccountAdjustment $account_adjustment)
    {
        return $account_adjustment->delete();
    }
