...
class DebentureCashingRepository
{
    private $debenture_cashing;
     ...
     * @return void
     */
    public function __construct(DebentureCashing $debenture_cashing)
    {
        $this->data = $debenture_cashing->with('user', 'user.profile', 'customer', 'branch');
    }
     ...
     * @return branch
     */
    public function update(DebentureCashing $debenture_cashing, $params)
    {
        $debenture_cashing->forceFill($this->formatParams($params, 'update'))->save();
        return $debenture_cashing;
    }
     ...
     * @return bool|null
     */
    public function delete(DebentureCashing $debenture_cashing)
    {
        return $debenture_cashing->delete();
    }
