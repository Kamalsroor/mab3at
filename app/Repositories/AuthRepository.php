...
class AuthRepository
{
    ...
    public function check()
    {
        ...
        \Cache::put('direction', ($auth_user->UserPreference->direction === 'rtl' ? 'rtl' : 'ltr'), 1440 * 60);
        \Cache::put('locale',$auth_user->UserPreference->locale, 1440 * 60);

        $configuration['user_direction']   = $auth_user->UserPreference->direction;
        $configuration['user_locale']      = $auth_user->UserPreference->locale;
        $configuration['user_sidebar']     = $auth_user->UserPreference->sidebar;
        $configuration['user_color_theme'] = $auth_user->UserPreference->color_theme;
